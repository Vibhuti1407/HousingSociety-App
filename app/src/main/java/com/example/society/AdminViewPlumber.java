...
public class AdminViewPlumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_plumber);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(AdminViewPlumber.this,AdminStaffDet.class));
    }
}