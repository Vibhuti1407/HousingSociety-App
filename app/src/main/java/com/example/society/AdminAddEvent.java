        ...
        btn_generate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(Description)) {
                    Toast.makeText(AdminAddEvent.this, "Please enter description", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AdminAddEvent.this,"Event Recorded ",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(AdminAddEvent.this,AdminEventDet.class));
                }
            }
        });
    }
