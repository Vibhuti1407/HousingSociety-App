...
public class AdminViewElectrician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_electrician);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(AdminViewElectrician.this,AdminStaffDet.class));
    }
}