...
public class MemberViewCleaner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_view_cleaner);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(MemberViewCleaner.this, MemberStaffDet.class);
